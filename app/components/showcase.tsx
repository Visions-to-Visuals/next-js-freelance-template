export default function Showcase() {
    ...
    function ShowcaseClient({image}) {
        return(
            ...
            hover:scale-[1.05] duration-300 cursor-pointer tablet-s:w-[8rem] ">
                <img src={image} className="w-[10em] aspect-[1/1] object-cover tablet-s:w-[8rem]"></img>
            </div>
        )
    }
    ...
    <section className="bg-primary py-14 text-secondary px-[2rem]">
        ...
        <p className="font-[Outfit] w-[58rem] mx-auto text-center mt-10 text-[1.3rem] tablet-s:w-[100%]">
        ...
        <div className="flex justify-center items-center mt-[3rem] gap-[10rem] mb-10 tablet-s:flex-wrap tablet-s:gap-[4rem]">
        ...
        <div className="flex justify-center items-center my-[4rem] gap-[4.5rem] tablet-s:gap-x-[4rem] tablet-s:flex-wrap">
