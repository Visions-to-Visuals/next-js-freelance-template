        ...
        <section className="bg-background py-14">
            ...
            <div className="flex justify-center items-center mt-14 mb-10 gap-24">
                <div className="flex flex-col justify-center items-start gap-5 w-[40rem]">
                    <BenefitsItem text="Insert a sentence from the company about Benefit Number 1. Insert another sentence about the benefit."></BenefitsItem>
                    <BenefitsItem text="Insert a sentence from the company about Benefit Number 2. Insert another sentence about the benefit."></BenefitsItem>
                    <BenefitsItem text="Insert a sentence from the company about Benefit Number 3. Insert another sentence about the benefit."></BenefitsItem>
                    <BenefitsItem text="Insert a sentence from the company about Benefit Number 4. Insert another sentence about the benefit."></BenefitsItem>
                </div>
